...
/**
 * HashAlgoNotSet: 'Hash algorithm is None'
 *
 * @category Errors
 * @category generated
 */
export class HashAlgoNotSetError extends Error {
  readonly code: number = 0x1782
  readonly name: string = 'HashAlgoNotSet'
  constructor() {
    super('Hash algorithm is None')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, HashAlgoNotSetError)
    }
  }
}

createErrorFromCodeLookup.set(0x1782, () => new HashAlgoNotSetError())
createErrorFromNameLookup.set('HashAlgoNotSet', () => new HashAlgoNotSetError())

/**
 * CodeMismatch: 'Private pair code mismatch.'
 *
 * @category Errors
 * @category generated
 */
export class CodeMismatchError extends Error {
  ...
  readonly name: string = 'CodeMismatch'
  constructor() {
    super('Private pair code mismatch.')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, CodeMismatchError)
    }
  }
}

createErrorFromCodeLookup.set(0x1783, () => new CodeMismatchError())
createErrorFromNameLookup.set('CodeMismatch', () => new CodeMismatchError())

/**
 * MissingPrivatePairHash: 'Private pair hash is missing in affair.'
 *
 * @category Errors
 * @category generated
 */
export class MissingPrivatePairHashError extends Error {
  readonly code: number = 0x1784
  readonly name: string = 'MissingPrivatePairHash'
  constructor() {
    super('Private pair hash is missing in affair.')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, MissingPrivatePairHashError)
    }
  }
}

createErrorFromCodeLookup.set(0x1784, () => new MissingPrivatePairHashError())
createErrorFromNameLookup.set(
  'MissingPrivatePairHash',
  () => new MissingPrivatePairHashError()
)

/**
 * MissingPrivatePairCode: 'Private pair code is missing in instruction.'
 *
 * @category Errors
 * @category generated
 */
export class MissingPrivatePairCodeError extends Error {
  readonly code: number = 0x1785
  readonly name: string = 'MissingPrivatePairCode'
  constructor() {
    super('Private pair code is missing in instruction.')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, MissingPrivatePairCodeError)
    }
  }
}

createErrorFromCodeLookup.set(0x1785, () => new MissingPrivatePairCodeError())
createErrorFromNameLookup.set(
  'MissingPrivatePairCode',
  () => new MissingPrivatePairCodeError()
)

/**
 * ShagaPaused: 'Shaga Paused.'
 *
 * @category Errors
 * @category generated
 */
export class ShagaPausedError extends Error {
  readonly code: number = 0x1786
  readonly name: string = 'ShagaPaused'
  constructor() {
    super('Shaga Paused.')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, ShagaPausedError)
    }
  }
}

createErrorFromCodeLookup.set(0x1786, () => new ShagaPausedError())
createErrorFromNameLookup.set('ShagaPaused', () => new ShagaPausedError())

/**
 * ClockWorkKeyMismatch: 'Invalid Clockwork Key mismatch'
 *
 * @category Errors
 * @category generated
 */
export class ClockWorkKeyMismatchError extends Error {
  readonly code: number = 0x1787
  readonly name: string = 'ClockWorkKeyMismatch'
  constructor() {
    super('Invalid Clockwork Key mismatch')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, ClockWorkKeyMismatchError)
    }
  }
}

createErrorFromCodeLookup.set(0x1787, () => new ClockWorkKeyMismatchError())
createErrorFromNameLookup.set(
  'ClockWorkKeyMismatch',
  () => new ClockWorkKeyMismatchError()
)
