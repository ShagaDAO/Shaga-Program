...
export type StartRentalInstructionArgs = {
  ...
  privatePairHashCode: beet.COption<string>
}
/**
 * @category Instructions
 * @category StartRental
 * @category generated
 */
export const startRentalStruct = new beet.FixableBeetArgsStruct<
...
>(
  [
    ...
    ['privatePairHashCode', beet.coption(beet.utf8String)],
  ],
  'StartRentalInstructionArgs'
)
/**
 ...
 * @property [_writable_] feeDestination
