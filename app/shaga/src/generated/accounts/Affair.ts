...
import { HashAlgorithm, hashAlgorithmBeet } from '../types/HashAlgorithm'
...
export type AffairArgs = {
  ...
  privatePairHash: beet.COption<Uint8Array>
}
...
export class Affair implements AffairArgs {
  private constructor(
    ...
    readonly privatePairHash: beet.COption<Uint8Array>
  ) {}
  ...
  pretty() {
    return {
      ...
      hashAlgorithm: 'HashAlgorithm.' + HashAlgorithm[this.hashAlgorithm],
      privatePairHash: this.privatePairHash,
    }
  }
}
...
>(
  [
    ...
    ['hashAlgorithm', hashAlgorithmBeet],
    ['privatePairHash', beet.coption(beet.bytes)],
  ],
  Affair.fromArgs,
  'Affair'
)
